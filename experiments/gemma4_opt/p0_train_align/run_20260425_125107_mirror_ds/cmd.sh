...
{
    "_purpose": "FSDP2 align run mirroring DS prod-baseline. ZeRO-3 (full reshard) + AC=on, gemma4-specific workarounds. NO CPU offload (mem_efficient SDPA + paged AdamW gives enough headroom).",

...
{
    "_purpose": "FSDP2 align run mirroring DS prod-baseline. ZeRO-3 (full reshard) + AC=on + CPU offload (params/grads/fp32-master) + activation_cpu_offload, gemma4-specific workarounds.",

...
> 镜像：`fangyaohua/gemma4-e4b-it-sft:260506-u22.04-cu12.9.1-py3.12-t2.10.0-v0.19.0-m1.35.4-s4.1.2-v2`
>
...
docker run --rm -it --gpus all --shm-size=16g --ipc=host \
  ...
  -e OUT_ROOT=/runs \
  fangyaohua/gemma4-e4b-it-sft:260506-u22.04-cu12.9.1-py3.12-t2.10.0-v0.19.0-m1.35.4-s4.1.2-v2 \
